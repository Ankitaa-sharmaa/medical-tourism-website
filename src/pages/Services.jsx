  ...
  return (
    <>
      ...
      <section
        ...
        style={{
          backgroundImage:
            "url('https://images.unsplash.com/photo-1587351021759-3e566b3db4f1?q=80&w=2070&auto=format&fit=crop')",
        }}
      >
        ...
        <div className="relative z-10 px-6 md:px-20" data-aos="fade-up">
          ...
          <p className="text-slate-300 mt-5 text-lg max-w-xl leading-relaxed">
            Access India's finest specialists and hospitals across every major medical
            specialty — at up to 80% lower cost.
          </p>
        </div>
      </section>
      ...
      <section className="px-6 md:px-20 py-24 bg-white">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {filtered.map((s, i) => (
            <div
              key={s.title}
              className={`bg-gradient-to-br ${s.gradient} border ${s.border} p-8 rounded-3xl hover:-translate-y-2 hover:shadow-lg transition-all duration-300 group relative`}
              data-aos="fade-up"
              data-aos-delay={i * 80}
            >
              {s.tag && (
              ...
              <div
                className={`w-14 h-14 ${s.iconBg} rounded-2xl flex items-center justify-center text-white text-xl mb-6 shadow-sm`}
              >
                {s.icon}
              </div>
      ...
      <section className="px-6 md:px-20 py-24 bg-slate-50">
        ...
        <div
          className="max-w-4xl mx-auto overflow-hidden border border-slate-200 rounded-3xl shadow-sm bg-white"
          data-aos="fade-up"
          data-aos-delay="100"
        >
          ...
          {COMPARE_ROWS.map((row, i) => (
            <div
              key={i}
              className={`grid grid-cols-3 px-6 py-5 text-sm items-center border-b border-slate-100 ${
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div data-aos="fade-right">
            ...
            <h2 className="text-4xl md:text-5xl font-black mb-6 leading-tight text-slate-900">
              Not Just a Booking
              <br />
              Platform. A Care Partner.
            </h2>
            <p className="text-slate-600 leading-relaxed text-base mb-8">
              Unlike generic medical tourism brokers, MedTour employs in-house medical
              advisors, multilingual care coordinators, and dedicated travel specialists.
              We manage every detail — from second medical opinions to post-discharge
              telemedicine — so you never feel alone in a foreign country.
            </p>
      ...
      <section className="px-6 md:px-20 py-20 bg-slate-50">
        <div
          className="relative bg-gradient-to-br from-sky-50 via-cyan-50 to-white border border-sky-200 rounded-3xl p-12 text-center overflow-hidden shadow-sm"
          data-aos="fade-up"
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-slate-600 max-w-lg mx-auto mb-8">
              Our medical advisors will review your case for free and recommend the right
              hospital, specialist, and treatment plan for you.
            </p>
            <Link
              to="/contact"
